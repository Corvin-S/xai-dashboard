...
from components.feature_mapping import decode_case
...
if "condition" not in st.session_state:
    st.session_state.condition = "gauge"
...
with conf_col:
    with st.container(border=True):
        ...
        st.caption(
            "How confident the model is in this prediction — the higher the value, the more certain."
        )
        st.markdown("**Select Visualization Type:**")
        st.session_state.condition = st.radio(
            "",
            ["gauge", "text"],
            horizontal=True,
            label_visibility="collapsed"
        )
        if st.session_state.condition == "gauge":
...
# Map encoded feature names to readable labels
